...
const CustomSelectOptions: React.FC<FieldComponentProps> = ({item, onChange, config}) => {
        ...
        <>
            ...
            <Accordion activeIndex={0}>
                ...
                <AccordionTab header="Options" key="options">
                    ...
                    <div className="mt-4">
                    {data.source === "local" && <CustomSelectOptions item={data} onChange={onChange} config={config}/>}
                    </div>
                </AccordionTab>
